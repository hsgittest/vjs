...
const span1 = document.querySelector("#quote span:first-child");
const span2 = document.querySelector("#quote span:last-child");
const quote = quotes[Math.floor(Math.random() * quotes.length)];
span1.innerText = `${quote.quote}\n`;
span2.innerText = quote.author;
